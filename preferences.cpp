...
// GUID's
//
static const GUID guid_access_token = { 0x980e1f, 0x272e, 0x4eb5, { 0xb7, 0xd7, 0x32, 0x1e, 0x1e, 0x85, 0x44, 0x3d } };

static const GUID guid_login_dlg_size = { 0x7da433cf, 0xf8a8, 0x4b5b, { 0x8d, 0x8f, 0x2a, 0xf9, 0xaa, 0x2, 0x76, 0x86 } };
static const GUID guid_login_dlg_pos = { 0xcc80a64a, 0x44de, 0x4735, { 0x93, 0xdf, 0xc7, 0x92, 0x63, 0xbb, 0x3a, 0x23 } };

static const GUID guid_upload_setup_dlg_pos = { 0x2196cbc0, 0x53b, 0x4ed7, { 0x97, 0xfa, 0xf, 0x3d, 0x52, 0x7d, 0x67, 0x0 } };

//
// cfg vars
//
cfg_string vk_access_token (guid_access_token, "");

cfgWindowSize vk_login_dlg_size (guid_login_dlg_size);
cfgDialogPosition vk_login_dlg_pos (guid_login_dlg_pos);

cfgDialogPosition vk_upload_setup_dlg_pos (guid_upload_setup_dlg_pos);
