...
namespace vk_uploader
{
    ...
    public:
        ...
        upload_setup_dlg (metadb_handle_list_cref p_items, const cfg::upload_profile &p_profile) 
    ...
    {
        void show (metadb_handle_list_cref p_items, const cfg::upload_profile &p_profile) override
        {
