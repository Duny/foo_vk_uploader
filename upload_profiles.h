...
namespace vk_uploader
{
    namespace upload_profiles
    {
        ...
        PFC_DECLARE_EXCEPTION (exception_create_guid_fail, exception_profiles_manager, "CoCreateGuid failed");
        ...
        public:
            ...
            virtual void save_profile (const pfc::string8 &p_name, const profile &p_profile) = 0;

            virtual void delete_profile (const pfc::string8 &p_name) = 0;
